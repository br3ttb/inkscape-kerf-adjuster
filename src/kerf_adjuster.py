...
that a laser cutter's beam has some width.
	...
	for sel in nodes:   
		...
		if(is_text(sel)):
			...
			bodyMask.attrib["style"]="opacity:1;fill:#a0a0a0;fill-opacity:0;stroke:#ff0000;stroke-width:1;stroke-linejoin:round;stroke-miterlimit:4;stroke-dasharray:none;stroke-dashoffset:0;stroke-opacity:0.5"
			...
			kerfObject.attrib["style"]="opacity:1;fill:#a0a0a0;fill-opacity:0;stroke:#000000;stroke-width:"+str(2*kerfpx)+";stroke-linejoin:round;stroke-miterlimit:4;stroke-dasharray:none;stroke-dashoffset:0;stroke-opacity:0.5"
